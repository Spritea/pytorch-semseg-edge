...
def test(args,cfg):
    ...
    IMG_File=natsort.natsorted(list(IMG_Path.glob("*.jpg")),alg=natsort.PATH)
    IMG_Str=[]
    for i in IMG_File:
    ...
    for j in tqdm(range(len(IMG_Str))):
        ...
        out_path="test_out/segnet_solid_line_samesize_PLDU/"+Path(img_path).name
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="pretrain/solid_line_samesize/segnet_my_best_model.pkl",
        help="Path to the saved model",
    )
    parser.add_argument(
        "--img_path", nargs="?", type=str,
        default="dataset/solid_line_samesize/test", help="Path of the input image"
    )
    parser.add_argument(
        "--config",
        nargs="?",
        type=str,
        default="configs/segnet_my.yml",
